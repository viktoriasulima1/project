...
export interface FinanceData {
  ...
  recentEntries:Array<{id:string;date:string;label:string;kind:'cost'|'revenue';recordType:'expense'|'revenue';amount:number;status:string;version:number}>;
