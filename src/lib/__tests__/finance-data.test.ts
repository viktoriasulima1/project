...
const fs=()=>({id:'fs-1',fieldId:'field-1',crop:'wheat',field:{id:'field-1',name:'North',hectares:'10'},activities:[{actualHours:null,machineHours:null,costSnapshots:[{itemName:'Input',unitCost:'5'}]}],harvestResults:[{unit:'tonnes',saleableQuantity:'20',grossQuantity:'20'}],seasonPlanItems:[]});
